@foreach ($appartments as $appartment)
    <tr class="intro-x">
        ...
        <td class="text-center">{{ $appartment->square }}</td>
        <td class="text-center">{{ $appartment->terace }}</td>
        <td class="text-center">{{ $appartment->price }}</td>
        <td class="text-center">{{ $appartment->total }}</td>
        <td class="text-center">{{ $appartment->status }}</td>
